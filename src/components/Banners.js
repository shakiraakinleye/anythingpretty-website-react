...
export function NoticeBanner(){
    return (
        <div className="bg-black flex justify-center py-3 sm:py-4 border-b border-b-[#c8c8c8]">
...
export function HelpBanner(){
    return (
        <div className="bg-[#dcdcdc] flex justify-center sm:justify-end px-4 sm:px-8 lg:px-16 border-b border-b-[#c8c8c8]">
